...
public final class InpatientClaimTransformerTest {
	...
	static void assertMatches(InpatientClaim claim, ExplanationOfBenefit eob) throws FHIRException {
		...
		TransformerTestUtils.assertAdjudicationTotalEquivalent(CcwCodebookVariable.CLM_PASS_THRU_PER_DIEM_AMT,
				claim.getPassThruPerDiemAmount(), eob);
		TransformerTestUtils.assertAdjudicationTotalEquivalent(CcwCodebookVariable.NCH_PROFNL_CMPNT_CHRG_AMT,
				claim.getProfessionalComponentCharge(), eob);
		TransformerTestUtils.assertAdjudicationTotalEquivalent(CcwCodebookVariable.CLM_TOT_PPS_CPTL_AMT,
				claim.getClaimTotalPPSCapitalAmount(), eob);
		TransformerTestUtils.assertAdjudicationTotalEquivalent(CcwCodebookVariable.IME_OP_CLM_VAL_AMT,
				claim.getIndirectMedicalEducationAmount(), eob);
		TransformerTestUtils.assertAdjudicationTotalEquivalent(CcwCodebookVariable.DSH_OP_CLM_VAL_AMT,
		...
		TransformerTestUtils.assertAdjudicationTotalEquivalent(CcwCodebookVariable.NCH_DRG_OUTLIER_APRVD_PMT_AMT,
